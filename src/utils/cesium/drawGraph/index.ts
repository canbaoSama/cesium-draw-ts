...
import DrawGraphAngleBtwMeasure from '@/utils/cesium/drawGraph/angleBtwMeasure'
import DrawGraphAnglePitchMeasure from '@/utils/cesium/drawGraph/anglePitchMeasure'
...
const drawFunc: { [key: string | number]: any } = {
    ...
    DrawGraphAngleBtwMeasure,
    DrawGraphAnglePitchMeasure,
}
export {
    drawFunc,
    drawConfig,
